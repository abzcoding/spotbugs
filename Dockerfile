...
RUN cd /opt \
      ...
      && wget --quiet https://repo1.maven.org/maven2/com/h3xstream/findsecbugs/findsecbugs-plugin/1.9.0/findsecbugs-plugin-1.9.0.jar \
    #   && groupadd -g 999 spotbugs \
    #   && useradd -r -u 999 -g spotbugs spotbugs \
    #   && chown -R spotbugs:spotbugs /opt
